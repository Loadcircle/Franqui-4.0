...
<div class="container">
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item"><strong>Herramienta:</strong> {{$documento->pertenece_m->name}}</li>      
    ...
    <a class="btn btn-sm btn-danger my-3 float-right" style="color: white;" href="{{ route('smodulos', $smodulo) }}">Volver</a>
@endsection