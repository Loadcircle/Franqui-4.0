...
<div class="container">
    ...
    <ul class="list-group">
        ...
        <li class="list-group-item"><strong>Pertenece al modulo:</strong> {{$modulo->padre->name}}</li>
    ...
    <a class="btn btn-sm btn-danger my-3 float-right" style="color: white;" href="{{ route('smodulos',['pmodulo' => $modulo->padre->slug]) }}">Volver</a>
@endsection